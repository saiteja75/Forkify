...
class RecipeView {
    ...
    #generateMarkup() {
        ...
        <div class="recipe__ingredients">
            ...
            ${this.#data.ingredients.map(this.#generateRecipeItems).join('')} 
            </ul>
        </div>
    ...
    renderSpinner() {
        this.#clear();
        this.#parentElement.insertAdjacentHTML('afterbegin', `<div class="spinner">
        <svg>
    ...
    renderErrorMessage(msg = this.#errorMsg) {
